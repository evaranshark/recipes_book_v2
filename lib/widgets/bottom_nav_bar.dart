...
import 'package:recipes_book_v2/models.dart';
...
class EvaBottomNavBarState extends State<EvaBottomNavBar>{
  ...
  Widget build(BuildContext context) {
    List<NavigationDestination> items = AppData.bottomNavBarItemsData.map(
  ...
  _onItemSelected(int index) async{
    navigationHandler.onDestinationChanged(AppData.bottomNavBarItemsData[index].alias);
